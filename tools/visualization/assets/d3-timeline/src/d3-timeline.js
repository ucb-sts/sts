(function() {
  ...
  // timelineType currently only supports two types of timelines: 1d and 2d
  d3.timeline = function(timelineType) {
    ...
    var hover = function () {},
        ...
        beginning = 0,
        ending = 0,
        margin = {left: 120, right:400, top: 30, bottom:1000},
        stacked = false,
        rotateTicks = false,
        itemHeight = 20,
        itemMargin = 5,
    ...
    function timeline (gParent)
    {
      ...
      var baseWidth = width;  // initial width; do not change on zoom
      ...
      // set zoom behavior
      function setZoom(){
        var z = d3.behavior.zoom().x(xScale).scaleExtent([0,1000]).on("zoom", function (){
          var w = baseWidth * z.scale();
          if (w > baseWidth * 0.75 && w < baseWidth * 1000){
            width = w;
          }
