...
class Match:
  """ Very very early prototype of a match potion of a nom snapshot that is initialized from
      a JSON match (like the one from floodlight) """
...
class Snapshot:
  """ A Snapshot that can be intitialized from a JSON map """
